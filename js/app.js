...
*/
    ...
    gsapWithCSS.registerPlugin(Flip, ScrollTrigger, MotionPathPlugin, TextPlugin);
    const tl = gsapWithCSS.timeline();
    gsapWithCSS.to(".curtain__text", {
        top: "-20%",
        delay: 3,
        duration: 1,
        ease: "Power4.out"
    });
    gsapWithCSS.to(".double", {
        top: "120%",
        duration: 1,
        delay: 3,
        ease: "Power4.out"
    ...
    tl.to(".content-main__title", {
        translateY: 0,
        opacity: 1,
        duration: 1,
        ease: "Power4.out"
    });
    tl.to(".content-main__subtitle", {
        translateY: 0,
        opacity: 1,
        duration: 1,
        ease: "Power4.out"
    }, "-=0.8");
    tl.to(".content-main__btn", {
        translateY: 0,
        opacity: 1,
        duration: 1,
        ease: "Power4.out"
    }, "-=0.7");
    tl.to(".content-main__circle", {
        scale: 1,
        duration: 1,
        ease: "Power4.out"
    }, "-=1");
