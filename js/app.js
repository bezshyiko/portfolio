...
***************************************************************************** */
        ...
        const preloader = gsapWithCSS.timeline(), mainBlock = gsapWithCSS.timeline(), social = gsapWithCSS.timeline({
            scrollTrigger: {
                trigger: ".bottom-about__contact"
            }
        });
        ...
        social.to(".social__instagram", {
            ...
            translateX: 0,
            duration: .9
        }, "-=0.9").to(".social__viber", {
            opacity: 1,
            translateY: 0,
            translateX: 0,
            duration: .9
        }, "-=0.8").to(".social__telegram", {
            opacity: 1,
            translateY: 0,
            translateX: 0,
            duration: .9
